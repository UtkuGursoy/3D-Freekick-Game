...
bool Football::checkPlaneCollision(GameObject plane)
{
	...
	// Adjusts the scale vector for AABB to account for 90 degree rotations.
	if (plane.transform.rotation.x == 90 || plane.transform.rotation.x == 270) 
	{
