...
TexturedPlane::TexturedPlane(GLuint tex, float px, float py, float pz, float rx, float ry, float rz) : GameObject(px, py, pz, rx, ry, rz), m_texture(tex)
{
}


TexturedPlane::TexturedPlane(GLuint tex, float px, float py, float pz, float rx, float ry, float rz, float sx, float sy, float sz) : 
